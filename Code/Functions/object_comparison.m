...
%
% [] = object_comparison( PROJ_D , filename , LogId )
%
%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%ENTREES%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%-%
%
...
function [] = object_comparison( PROJ_D , kpack, filename_in , LogId )
...
[ TPR , TNR , Acc , Ntab , msk_TP , msk_FP , msk_FN , msk_TN ] = SensibilitySpecificity2imseg( msk_vessels_ref , msk_vessels , msk_ZOI );
